...
new_delhi_data['Date'] = pd.to_datetime(new_delhi_data['Date'], dayfirst = False, yearfirst = False)
new_delhi_data.sort_values(by=['Date'], inplace=True, ascending=True)
new_delhi_data = new_delhi_data.loc[(new_delhi_data['Date'] > '2020-03-15') & (new_delhi_data['Date'] <= '2020-04-14')]
print(new_delhi_data)
