...
london_data['Date'] = pd.to_datetime(london_data['Date'], dayfirst = False, yearfirst = False)
london_data.sort_values(by=['Date'], inplace=True, ascending=True)
london_data = london_data.loc[(london_data['Date'] > '2020-03-14') & (london_data['Date'] <= '2020-04-30')]
print(london_data)
